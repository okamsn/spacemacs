...
- [[#configuration][Configuration]]
  ...
  - [[#weighted-history-selection][Weighted history selection]]
...
** Weighted history selection
To have past selections appear as the top of suggestion lists set the layer
variable =ivy-enable-weighted-history-selection= to =t= which will enable
=ivy-prescient=.
...
#+BEGIN_SRC emacs-lisp
  (setq-default dotspacemacs-configuration-layers '(
    (ivy :variables ivy-enable-weighted-history-selection t)))
#+END_SRC
